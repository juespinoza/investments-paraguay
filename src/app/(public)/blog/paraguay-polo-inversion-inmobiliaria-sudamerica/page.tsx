...
export default function BlogPostPage() {
  return (
    <div className="container-page py-10">
      ...
      <div className="meta text-center mb-8 flex flex-col sm:flex-row sm:justify-center sm:gap-4 gap-2">
        <span className="pill">Actualizado: 27 Ene 2026</span>
        <span className="pill">Autor: Investments Paraguay</span>
      </div>
      <h3 className="mt-2 text-lg text-secondary mb-8">
      ...
      <h2 className="text-bold font-secondary mb-4">
        Paraguay empezó a aparecer en el radar regional
      </h2>
      <p className="mt-4 text-secondary text-justify mb-6">
      ...
      <ul className="mt-4 text-secondary text-justify mb-6 list-disc list-inside">
      ...
      <h2 className="text-bold font-secondary mb-4">Conclusión</h2>
      <p className="mt-4 text-secondary text-justify mb-16">
      ...
      <hr />
      <h4 className="my-4">Fuentes y referencias:</h4>
      <ul className="mt-4 text-secondary text-justify mb-6 list-disc list-inside">
        <li>
